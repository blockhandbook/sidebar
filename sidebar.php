...
define( 'SIDEBAR_PLUGIN_VERSION', '1.0.0' );
define( 'SIDEBAR_PLUGIN_SLUG', 'sidebar' );
define( 'SIDEBAR_PLUGIN_SLUG_SNAKE_CASE', 'sidebar' );
define( 'SIDEBAR_PLUGIN_SLUG_CAMEL_CASE', 'sidebar' );
define( 'SIDEBAR_PLUGIN_TEXTDOMAIN', 'sidebar' );
define( 'SIDEBAR_PLUGIN_FILE', __FILE__ );
define( 'SIDEBAR_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
define( 'SIDEBAR_PLUGIN_PATH', plugin_dir_path( __FILE__ ) );
